...
const AdminPanel = () => {
 ...
 const[users,setUser]=useState({name:"",email:""})
  ...
  const addSweet = async () => {
    ...
    try {
      const t = sessionStorage.getItem('token');
      const response = await fetch(`${apiUrl}/api/sweets`, {
        method: "POST",
        headers: {
  ...
  const deleteSweet = async(id) => {
    ...
    try {
      const t = sessionStorage.getItem("token");
      const response = await fetch(`${apiUrl}/api/sweets/${id}`, {
        method: "DELETE",
        headers: {
          Authorization: t,
          role: "admin",
  ...
  const restockSweet = async(id) => {
    ...
    try {
      ...
      const response = await fetch(`${apiUrl}/api/sweets/${id}/restock`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: t,
  ...
  const saveSweet = async () => {
    const t = sessionStorage.getItem('token');
    await fetch(`${apiUrl}/api/sweets/${editingSweetId}`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
        Authorization: t,
